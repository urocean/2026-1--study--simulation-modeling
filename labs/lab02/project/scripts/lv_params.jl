...
params = [
    ...
    (0.2, 0.02, 0.01, 0.3),   # больше рождаемость жертв
    (0.1, 0.04, 0.01, 0.3),   # больше поедание
    (0.1, 0.02, 0.02, 0.3),   # выше конверсия
    (0.1, 0.02, 0.01, 0.5)    # выше смертность хищников
]

for (α, β, δ, γ) in params
    p_test = [α, β, δ, γ]
