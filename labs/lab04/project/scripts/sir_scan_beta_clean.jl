...
threshold = minimum(grouped[grouped.mean_peak .> 0.05, :beta])
R0_threshold = 1
β_theoretical = R0_threshold * γ
println("Пороговое β = $threshold")
println("Теоретический порог = $β_theoretical")
